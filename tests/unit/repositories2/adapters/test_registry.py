...
def test_defaultproviderregistry_non_empty():
    """It is not empty."""
    assert defaultproviderregistry


def test_defaultproviderregistry_strings():
...
def test_defaultproviderregistry_providerfactories(store: ProviderStore):
