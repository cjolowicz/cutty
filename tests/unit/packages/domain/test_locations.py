...
from cutty.packages.domain.locations import aspureposixpath
from cutty.packages.domain.locations import aspurewindowspath
...
from cutty.packages.domain.locations import realpath
